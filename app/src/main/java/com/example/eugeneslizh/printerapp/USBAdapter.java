...
public class USBAdapter {
    ...
    public void createConn(Context context) {
        ...
        final String ACTION_USB_PERMISSION = "com.example.eugeneslizh.printerapp.USB_PERMISSION";
    ...
    private static final String ACTION_USB_PERMISSION =
            "com.example.eugeneslizh.printerapp.USB_PERMISSION";
...
//        if (mUsbManager.hasPermission(mDevice)) {
        mDevice = ((UsbManager) context.getSystemService(Context.USB_SERVICE)).getDeviceList().get(0);
            ...
            for (int i = 0; i < intf.getEndpointCount(); i++) {
                ...
                if (ep.getType() == UsbConstants.USB_ENDPOINT_XFER_BULK) {
                    if (ep.getDirection() == UsbConstants.USB_DIR_OUT) {
                        ...
                        Toast.makeText(context, "Rsult" + res, Toast.LENGTH_SHORT).show();
